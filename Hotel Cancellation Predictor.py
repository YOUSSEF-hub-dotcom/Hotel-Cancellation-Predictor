...
df = pd.read_csv('C:\\Users\\youss\\Downloads\\hotels.csv')
...
X = pd.get_dummies(X, columns=['arrival_date_month'], dtype=int)
...
grid_search = GridSearchCV(xgb, param_grid=param_grid, cv=3, n_jobs=-1, verbose=1)
